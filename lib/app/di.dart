...
class DI {
  ...
  static set authGuard(AuthGuard guard) {
    if (sl.isRegistered<AuthGuard>()) {
      sl.unregister<AuthGuard>();
    }
    sl.registerSingleton<AuthGuard>(guard);
  }

  static set appRouter(AppRouter router) {
