...
import 'package:smart_interview_ai/presentation/pre_interview/widgets/question_card.dart';
...
class PreInterviewPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          sl<PreInterviewBloc>()..add(const PreInterviewQuestionsRequested()),
      child: Scaffold(
        ...
        body: BlocBuilder<PreInterviewBloc, PreInterviewState>(
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () => context.read<PreInterviewBloc>().add(
